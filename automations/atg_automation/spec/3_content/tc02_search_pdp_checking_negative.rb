...
=begin
ATG Content: Verify all apps that are not supported for current locale shouldn't displayed
=end

describe "SKU Searching negative - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
