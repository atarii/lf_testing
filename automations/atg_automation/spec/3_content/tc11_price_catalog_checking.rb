...
=begin
ATG Content: Fill by Price and check app information on Catalog page
=end

describe "Price catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
