...
feature "DST12 - Catalog - Add to Cart from Catalog page - ENV = '#{Data::ENV_CONST}' - Locale = '#{Data::LOCALE_CONST}'", js: true do
  before :all do
    # Login to LF account
  ...
  context 'On App Center Catalog page' do
    ...
    scenario "3. Click on 'Add to Cart' button from Catalog page" do
